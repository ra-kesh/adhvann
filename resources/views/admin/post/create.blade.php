                                ...
                                <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="name" name="subtitle" value="{{ old('subtitle') }}" class="form-control" placeholder="Enter subtitle">
                                        </div>
                                        <div class="form-group">
...
@section('script')
    ...
    <script> $(document).ready(function() {
         ...
         { $('div.panel-body img').css({'width' : '100%'});
          $('div.panel-body iframe').css({'width' : '100%'}); }); 
        }); 
    </script>
    <script>
        $('#description').summernote({
            placeholder: 'Hello Adhvannians...',
            tabsize: 2,
            height: 300
        });
